...
<head>
    ...
    <title>Log in - {{ config('app.name', 'BookHub') }}</title>
...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <a href="{{ url('/') }}" class="flex justify-center items-center gap-x-2 text-2xl font-bold text-gray-900">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                <a href="{{ route('register') }}" class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Sign
                    up</a>
            </p>
        </div>
    </div>
