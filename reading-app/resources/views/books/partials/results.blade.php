<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead class="bg-white dark:bg-slate-800">
            <tr>
                <th scope="col"
                    class="px-6 py-3 text-start text-xs font-bold text-gray-400 uppercase tracking-wider font-heading">
                    Titre</th>
                <th scope="col"
                    class="px-6 py-3 text-start text-xs font-bold text-gray-400 uppercase tracking-wider font-heading">
                    Description</th>
                ...
                <th scope="col"
                    ...
                    Catégories</th>
                <th scope="col"
                    class="px-6 py-3 text-end text-xs font-bold text-gray-400 uppercase tracking-wider font-heading">
                    Actions</th>
            </tr>
        </thead>
                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate"
                            title="{{ $book->description }}">{{ $book->description }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
...
<!-- Footer / Pagination -->
<div
    class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-900 flex justify-center items-center">
